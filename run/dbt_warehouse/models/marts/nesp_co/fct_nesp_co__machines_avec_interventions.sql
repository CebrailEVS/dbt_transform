    ...
    create or replace table `evs-datastack-prod`.`prod_marts`.`fct_nesp_co__machines_avec_interventions`
    ...
    OPTIONS(
      description="""Nombre d'interventions techniques r\u00e9alis\u00e9es sur les machines install\u00e9es chez les clients sur les 12 derniers mois.\n"""
    )
    as (
