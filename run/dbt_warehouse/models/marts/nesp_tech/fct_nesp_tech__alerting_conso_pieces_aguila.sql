    ...
    create or replace table `evs-datastack-prod`.`prod_marts`.`fct_nesp_tech__alerting_conso_pieces_aguila`
    ...
    OPTIONS(
      description="""Mod\u00e8le analytique de contr\u00f4le des consommations des interventions techniques Aguila. Ce mod\u00e8le consolide les consommations d\u2019articles et applique les r\u00e8gles m\u00e9tier permettant de d\u00e9tecter les incoh\u00e9rences de conso de pi\u00e8ces lors de maintenance pr\u00e9ventive, kits, filtres et pi\u00e8ces hors kit.\n"""
    )
    as (
...
select
    ...
    '523eafea-d40b-463d-a481-c61e6c295aca' as dbt_invocation_id  -- noqa: TMP
