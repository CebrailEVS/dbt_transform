    ...
    create or replace table `evs-datastack-prod`.`prod_marts`.`fct_finance__pnl_bu`
    ...
    OPTIONS(
      description="""P&L mensuel par Business Unit, avec sc\u00e9narios avec et sans provisions cong\u00e9s pay\u00e9s. Inclut KPI mensuels, YTD, N-1, \u00e9carts, \u00e9volutions et pourcentages du chiffre d'affaires.\n"""
    )
    as (
...
-- Enrichissement final
    select
        ...
        safe_divide(l.valeur - l.valeur_n_1, abs(l.valeur_n_1)) as evolution_pct,
        l.valeur_ytd - l.valeur_ytd_n_1 as ecart_n_vs_n_1_ytd,
        safe_divide(l.valeur_ytd - l.valeur_ytd_n_1, abs(l.valeur_ytd_n_1)) as evolution_pct_ytd,
...
select
    ...
    '13bacbc8-8f64-4f63-8609-543b28e551d7' as dbt_invocation_id
