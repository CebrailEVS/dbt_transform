    ...
    create or replace table `evs-datastack-prod`.`prod_marts`.`fct_neshu__maintenance_preventive`
...
final as (
    select
        ...
        '1abdb54c-d7d1-4f0f-b172-35eef6fbcb0c' as dbt_invocation_id  -- noqa: TMP
