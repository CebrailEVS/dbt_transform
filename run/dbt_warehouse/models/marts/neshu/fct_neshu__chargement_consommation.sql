    ...
    OPTIONS(
      description="""Table de faits des chargements et consommations t\u00e9l\u00e9metrie par passage APPRO. Pour chaque passage, mesure les quantit\u00e9s consomm\u00e9es entre le passage pr\u00e9c\u00e9dent et le passage actuel, et les quantit\u00e9s charg\u00e9es lors de ce passage. Grain : (device, passage_appro, product).\n"""
    )
    as (
...
select
    ...
    'dee3c756-046b-46db-822e-5791da48e93a' as dbt_invocation_id  -- noqa: TMP
