    ...
    OPTIONS(
      description="""Mod\u00e8le interm\u00e9diaire des clients NESP CO. Association du client avec l'identifiant C4C le plus r\u00e9cent issu des opportunit\u00e9s et activit\u00e9s via d\u00e9duplication par date.\n"""
    )
    as (
