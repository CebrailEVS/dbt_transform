    ...
    OPTIONS(
      description="""Table interm\u00e9diaire des t\u00e2ches de d'ecart inventaire. Filtr\u00e9e sur les t\u00e2ches de type ECART INVENTAIRE (idtask_type=163)  avec statut FAIT/VALIDE/ANNULE.\n"""
    )
    as (
