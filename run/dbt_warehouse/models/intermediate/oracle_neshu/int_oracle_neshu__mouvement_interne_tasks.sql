    ...
    create or replace table `evs-datastack-prod`.`prod_intermediate`.`int_oracle_neshu__mouvement_interne_tasks`
    ...
    OPTIONS(
      description="""Table interm\u00e9diaire des t\u00e2ches de Mouvement interne. Filtr\u00e9e sur les t\u00e2ches de type MOUVEMENT INTERNE (idtask_type=161)  avec statut FAIT/VALIDE/ANNULE.\n"""
    )
    as (
