    ...
    OPTIONS(
      description="""[QUOI M\u00c9TIER] Dotation aux amortissements mensuelle, par machine et par client : la machine elle-m\u00eame et ses sous-\u00e9quipements.\n[COMMENT CONSTRUITE] Machines (device de type 1) vues sur une t\u00e2che du mois aux statuts 1/4/5/7, chez un client sous contrat avant le mois. Dotation lin\u00e9aire = purchase_cost / damping_duration, arr\u00eat\u00e9e quand l'amortissement est termin\u00e9 avant le mois. Dur\u00e9es par d\u00e9faut : 36 mois pour la machine, 60 pour un sous-\u00e9quipement. Les sous-\u00e9quipements sont agr\u00e9g\u00e9s AVANT jointure.\n[GRAIN] 1 ligne par (mois, company_id, device_id).\n[NOTES] \u00c9CART VOLONTAIRE avec Distrilog, chiffr\u00e9 \u00e0 +841 \u20ac sur ao\u00fbt 2026 \u2014 d\u00e9tail dans le YAML de fct_finance__pnl_client_mensuel, note (3). En r\u00e9sum\u00e9 : leur requ\u00eate groupe les sous-\u00e9quipements par la VALEUR de la dotation et non par leur identifiant, ce qui fusionne ceux qui co\u00fbtent pareil (105 machines, sous-\u00e9valuation) et d\u00e9multiplie la dotation de la machine quand ils diff\u00e8rent (662 machines, sur\u00e9valuation). Ce mod\u00e8le compte chaque sous-\u00e9quipement une fois et chaque machine une fois. La date de r\u00e9f\u00e9rence est le premier jour du mois de la ligne et non la date du calcul, ce qui rend le mod\u00e8le rejouable. 700 machines sur 2 580 n'ont pas de purchase_cost au 2026-09-15 : leur dotation vaut z\u00e9ro, donn\u00e9e absente \u00e0 la source.\n"""
    )
    as (
