    ...
    OPTIONS(
      description="""Table interm\u00e9diaire des t\u00e2ches de Livraison interne. Filtr\u00e9e sur les t\u00e2ches de type LIVRAISON INTERNE (idtask_type=161) avec statut FAIT/VALIDE/ANNULE.\n"""
    )
    as (
