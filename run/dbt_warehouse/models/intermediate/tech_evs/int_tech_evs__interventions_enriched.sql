    ...
    create or replace table `evs-datastack-prod`.`prod_intermediate`.`int_tech_evs__interventions_enriched`
    ...
    OPTIONS(
      description="""Table interm\u00e9diaire consolidant les interventions techniques provenant des syst\u00e8mes NESP et YUMAN. Elle sert de base pour le calcul des indicateurs op\u00e9rationnels, la facturation partenaire et les primes techniciens.\n"""
    )
    as (
