    ...
    OPTIONS(
      description="""Une ligne par p\u00e9riode (segment) pendant laquelle le ticket reste dans un m\u00eame statut. Construit en appliquant LEAD() sur ticket_status_events : le segment N commence \u00e0 event_at[N] et se termine \u00e0 event_at[N+1]. Le dernier segment (statut final) a segment_end_at = NULL et duration = NULL. Les \u00e9v\u00e9nements de fusion (TicketMergedMaster) sont exclus. Sert de base pour calculer les temps pass\u00e9s en On Hold / Open / Closed.\n"""
    )
    as (
