    ...
    OPTIONS(
      description="""M\u00e9triques SLA par ticket \u2014 1 ligne par ticket. Agr\u00e8ge trois sources : ticket_threads (first_agent_response_at), ticket_status_events (first_close_at / last_close_at, nb_reopens), ticket_lifecycle_segments (temps pass\u00e9s en Open / On Hold). Toutes les dur\u00e9es existent en deux variantes :\n  - _calendar : minutes calendaires (24/7)\n  - _business : minutes ouvr\u00e9es (9h-17h30 FR, hors weekends et f\u00e9ri\u00e9s)\nTrois d\u00e9finitions de \"resolution time\" :\n  - first_close      : cr\u00e9\u00e9 \u2192 PREMIER close (ignore r\u00e9-ouvertures)\n  - last_close       : cr\u00e9\u00e9 \u2192 DERNIER close (inclut tous les cycles)\n  - excluding_hold   : somme des segments Open uniquement (exclut attente client)\nR\u00e8gles internes en attente de la confirmation Zoho support sur leur dashboard officiel.\n"""
    )
    as (
