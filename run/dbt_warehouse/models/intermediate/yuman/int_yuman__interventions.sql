    ...
    OPTIONS(
      description="""Mod\u00e8le interm\u00e9diaire consolid\u00e9 des interventions Yuman, source de v\u00e9rit\u00e9 unique pour la qualification m\u00e9tier, la tarification automatique et le d\u00e9lai de traitement. Construit sur int_yuman__demands_workorders_enriched, il fusionne ici la logique qui \u00e9tait auparavant \u00e9clat\u00e9e en deux faits cha\u00een\u00e9s (fct_technique__workorder_pricing puis fct_neshu__workorder_delai), supprimant ainsi les d\u00e9pendances fait\u2192fait. Couvre : (1) normalisation type/machine/m\u00e9tropole + extraction du code postal, (2) tarification automatique (r\u00e9currence \u2192 palier de remise \u2192 montant via table de r\u00e9f\u00e9rence), (3) d\u00e9lai en jours ouvr\u00e9s et son type (J+0,5 \u2026 J++), (4) qualification m\u00e9tier via intervention_state. P\u00e9rim\u00e8tre : exclut les bons de travail \"secs\" (sans demande rattach\u00e9e, demand_id NULL), d\u00e9pourvus de r\u00e9f\u00e9rentiel client/partenaire fiable (partner_name, client_id\u2026 NULL) qui fausserait la cl\u00e9 d'intervention aval et la tarification (~44 lignes en prod). Grain : 1 ligne par couple (demand_id, workorder_id). Inclut les demandes sans bon de travail (workorder_id NULL \u2192 DEMANDE_OUVERTE / DEMANDE_REJETEE) ; exclut l'inverse.\n"""
    )
    as (
