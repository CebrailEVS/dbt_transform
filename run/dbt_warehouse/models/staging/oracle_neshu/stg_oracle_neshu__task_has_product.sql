-- back compat for old kwarg name
    ...
    merge into `evs-datastack-prod`.`prod_staging`.`stg_oracle_neshu__task_has_product` as DBT_INTERNAL_DEST
        using (
