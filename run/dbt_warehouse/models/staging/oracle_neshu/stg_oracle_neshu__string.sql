    ...
    create or replace table `evs-datastack-prod`.`prod_staging`.`stg_oracle_neshu__string`
    ...
    OPTIONS(
      description="""Libell\u00e9s traduits de l'ERP, nettoy\u00e9s depuis la base Oracle. R\u00e9sout les idstring en texte lisible."""
    )
    as (
