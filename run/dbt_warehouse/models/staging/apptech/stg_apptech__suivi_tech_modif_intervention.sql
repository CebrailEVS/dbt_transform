    ...
    create or replace table `evs-datastack-prod`.`prod_staging`.`stg_apptech__suivi_tech_modif_intervention`
    ...
    OPTIONS(
      description="""Modifications d'intervention (d\u00e9cision de facturation \u00e9ventuelle et/ou technicien r\u00e9el). a_facturer peut \u00eatre NULL (modif sans d\u00e9cision de facturation). Dedup snapshot : seules les lignes du dernier fichier NDJSON de chaque mois sont conserv\u00e9es. Pas de test de freshness (soumissions humaines).\n"""
    )
    as (
